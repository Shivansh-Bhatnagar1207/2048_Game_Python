...
def move_tiles(window,tiles,clock,direction):
    ...
    if direction == 'left':
        ...
        move_check = lambda tile,next_tile : tile.x>next_tile.x +RECT_WIDTH + MOV_VEL
        ceil = True
        ...
        move_check = lambda tile,next_tile : tile.y > next_tile.y + RECT_HEIGHT + MOV_VEL
        ceil = True
    elif direction == 'down':
        sort_func = lambda y : y.row
        reverse = True
        ...
        get_next_tile = lambda tile: tiles.get(f"{tile.row+1}{tile.col}")
        merge_check = lambda tile,next_tile : tile.y < next_tile.y - MOV_VEL
        move_check = lambda tile,next_tile : tile.y+RECT_HEIGHT+MOV_VEL < next_tile.y
        ceil = False
